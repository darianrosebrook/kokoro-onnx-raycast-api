...
const testConsecutiveAudio = async () => {
  console.log('📡 Testing consecutive audio streaming through dashboard AudioClient logic...');
  ...
  for (let i = 1; i <= 3; i++) {
    ...
    try {
      ...
      console.log(`✅ Success: ${totalBytes} bytes in ${chunkCount} chunks, ${duration.toFixed(2)}ms`);
