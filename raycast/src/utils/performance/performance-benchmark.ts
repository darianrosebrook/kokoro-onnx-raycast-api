...
import type { AdaptiveBufferManager } from "../tts/streaming/adaptive-buffer-manager.js";
...
class TTSBenchmark {
  ...
  private adaptiveBufferManager: AdaptiveBufferManager | null = null; // Will be set via integration
  private performanceMonitor: PerformanceMonitor | null = null; // Will be set via integration

  /**
   * Set adaptive buffer manager for integration
   */
  setAdaptiveBufferManager(bufferManager: AdaptiveBufferManager): void {
    this.adaptiveBufferManager = bufferManager;
    console.log("Adaptive buffer manager integrated with benchmark system");
  }
  ...
  setPerformanceMonitor(monitor: PerformanceMonitor): void {
    ...
    console.log("Performance monitor integrated with benchmark system");
  }
